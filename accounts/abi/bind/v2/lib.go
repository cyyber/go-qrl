...
// Package bind implements utilities for interacting with Hyperion contracts.
...
// specific custom Hyperion event types, and creating event subscriptions to monitor the
