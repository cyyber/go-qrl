...
type BlockHashContractCaller interface {
	...
	// CallContractAtHash executes a QRL contract call against the state at the specified block hash.
	CallContractAtHash(ctx context.Context, call qrl.CallMsg, blockHash common.Hash) ([]byte, error)
}
