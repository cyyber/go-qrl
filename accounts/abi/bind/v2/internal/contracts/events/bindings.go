...
//
// Hyperion: function EmitMulti() returns()
...
// invalid/nil inputs are passed.
//
// Hyperion: function EmitOne() returns()
...
// by contract.
//
// Hyperion: event basic1(uint256 indexed id, uint256 data)
...
// by contract.
//
// Hyperion: event basic2(bool indexed flag, uint256 data)
