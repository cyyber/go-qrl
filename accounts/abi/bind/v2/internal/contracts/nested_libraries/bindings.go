...
import (
	...
	"github.com/theQRL/go-zond/accounts/abi/bind/v2"
...
// C1 is an auto generated Go binding around a QRL contract.
type C1 struct {
	abi abi.ABI
}
...
// contract deployment.
//
// Hyperion: constructor(uint256 v1, uint256 v2) returns()
...
//
// Hyperion: function Do(uint256 val) pure returns(uint256 res)
...
// C2 is an auto generated Go binding around a QRL contract.
type C2 struct {
	abi abi.ABI
}
...
// L1 is an auto generated Go binding around a QRL contract.
type L1 struct {
	abi abi.ABI
}
...
// invalid/nil inputs are passed.
//
// Hyperion: function Do(uint256 val) pure returns(uint256)
...
// L2 is an auto generated Go binding around a QRL contract.
type L2 struct {
	abi abi.ABI
}
...
// L2b is an auto generated Go binding around a QRL contract.
type L2b struct {
	abi abi.ABI
}
...
// L3 is an auto generated Go binding around a QRL contract.
type L3 struct {
	abi abi.ABI
}
...
// L4 is an auto generated Go binding around a QRL contract.
type L4 struct {
	abi abi.ABI
}
...
// L4b is an auto generated Go binding around a QRL contract.
type L4b struct {
	abi abi.ABI
}
