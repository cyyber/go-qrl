...
// DB is an auto generated Go binding around a QRL contract.
type DB struct {
	abi abi.ABI
}
...
//
// Hyperion: function get(uint256 k) returns(uint256)
...
// invalid/nil inputs are passed.
//
// Hyperion: function getNamedStatParams() view returns(uint256 gets, uint256 inserts, uint256 mods)
...
// invalid/nil inputs are passed.
//
// Hyperion: function getStatParams() view returns(uint256, uint256, uint256)
...
// invalid/nil inputs are passed.
//
// Hyperion: function getStatsStruct() view returns((uint256,uint256,uint256))
...
// invalid/nil inputs are passed.
//
// Hyperion: function insert(uint256 k, uint256 v) returns(uint256)
...
// by contract.
//
// Hyperion: event Insert(uint256 key, uint256 value, uint256 length)
...
// by contract.
//
// Hyperion: event KeyedInsert(uint256 indexed key, uint256 value)
